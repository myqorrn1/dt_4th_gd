...
/* 
    ...
    - 모든 React 클래스형 컴포넌트의 기본 부모 클래스 이다.
...
class ClassComponent extends Component {
    ...
    /* 
        * 필드란?
        - 클래스 내부에 정의된 "속성" 을 의미.
        - 즉, 클래스의 인스턴스가 만들어질때 자동으로 초기화되는 변수라고 생각하면 됨.
    */
    student = '홍길동';
    // 클래스 내부에서 선언한 속성은 this.속성명 으로 접근 가능함.
...
// : 부모 컴포넌트에서 props 미전달시 '기본 값' 으로 보여줄 props 설정.
// - 클래스 바깥(외부)에서 설정.
// - 전통방식

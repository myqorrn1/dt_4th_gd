...
//   함수형 컴포넌트를 사용하는 것이 권장됨. (클래스형 컴포넌트 보다 많이 쓰인다!)

import PropTypes from 'prop-types';
// 1) 함수 선언문 방식
// function FunctionComponent() {
//     return <h1>여기는 함수형 컴포넌트</h1>;
// }
...
const FunctionComponent = ({ name = 'Sally', age = 28 }) => {
    ...
    // #3. defaultProps 매개변수 문법 활용( 현재 화살표함수 괄호안에 매개변수 )
    // 요즘 트렌드. 많이 씀
...
// 이는 개발 모드에서 컴포넌트의 렌더링과 life cycle 메서드가 두 번 호출되도록 해서
// 부작용(side effects)을 테스트하고 식별하는데 도움을 줌.
// 이로 인해 console.log가 두번 찍힐 수 있음.

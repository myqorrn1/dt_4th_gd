...
export default function SyntheticEvent() {
    function synEvent(e) {
        ...
        console.log(e); // 콘솔에 찍히는 e 객체는 합성 이벤트 객체임.
    }
    // * Synthetic Event 란? (합성된, 인공적인)
    ...
    /* 
        ...
        2. Cross-Browser Compatibility
            - 브라우저 별로 이벤트 처리 방식이 다르더라도 브라우저 간 차이를 신경쓰지 않아도 된다.
        3. ** 이벤트 위임 ** 방식을 사용하여 '최상위 요소'에서 이벤트를 관리한다.
            -> 성능 최적화!

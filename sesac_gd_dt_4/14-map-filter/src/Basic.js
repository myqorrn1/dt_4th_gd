...
/* 
    ...
    공통점
    - 둘다 배열의 각 요소를 순회하는 메서드다.

    * forEach
    - 배열의 각 요소에 대해 주어진 함수를 "실행" 하는 것이 목적!
    - "반환값"이 없는 함수.
        ㄴ 체이닝 불가.
    - 배열을 순회하면서 각 요소에 대해 이벤트를 발생 시키는데 사용.
    ...
    * 결론
    - 데이터 변형이 필요하거나 변형된 데이터를 가지고 추가적인 작업을 해야 한다면?
    => map 사용

    - 단순히 배열을 순회하며 각 요소에 대해 어떤 작업만 수행하고자 할 때는
    => foreach 사용
*/

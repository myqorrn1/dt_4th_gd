...
// 배열의 위치(인덱스) : 0 부터 시작
// 배열의 길이(크기) : 요소의 "개수" 와 동일함

const fruits = ['orange', 'pineapple', 'grape', 'apple'];
console.log(fruits);
console.log(fruits[0]); // 배열의 위치가 0인 요소 출력! orange
console.log(fruits[1]);
console.log(fruits[2]);
console.log(fruits[3]);

// JS 에서는 배열 원소의 '자료형'이 달라도 됨!
// 왜????
...
console.log(cat.meovv);

// 2. 대괄호 표기법([])
console.log(cat['name']);
console.log(cat['isCute']);

// 3. key가 변수에 저장(할당)되어 있을 때 사용법
const tempVal = 'name'; // name을 tempVal 에 저장(할당)하여
console.log(cat[tempVal]); // 장화
...
console.log(typeof null); // object , js의 초기 구현 중 하나로서, null 값을 object로 분류하는 것은 공식적으로 인정한 언어의 설계상 오류.. 무시하자.
...
// console.log(`수학,영어 평균점수는 ${avg}입니다.`);
...
let n3 = 123.9; // number
console.log(Number(n1), typeof Number(n1)); // 1 , true는 1임
console.log(Number(n2), typeof Number(n2)); // 0 , false는 0임
console.log(Number(n3), typeof Number(n3)); // 123.9
console.log(parseInt(n3, 10)); // n3 값을 10진수의 정수로 바꾸겠다! 123

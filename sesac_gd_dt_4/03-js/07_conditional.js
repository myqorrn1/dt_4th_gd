...
//     console.log('입력값이 잘못 되었습니다. 숫자 범위를 확인하세요.');
// } else if (number >= 90) {
//     console.log('A');
// } else if (number >= 80) {
//     console.log('B');
...
// - 필수는 아니지만, 사용하길 권장.
// - if문의 "else" 같은 존재.
// - switch 문의 "마지막"에 두는 것이 일반적!

// * break: 조건을 "빠져나갈때" 사용하는 키워드
// - 실행을 "중단"하고, switch문 블록을 빠져나감.
...
// break 문이 없으면 조건을 빠져나가지 않고 아래에 있는 모든 case의 코드도 실행됨.
